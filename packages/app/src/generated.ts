// Generated by @wagmi/cli@0.1.15 on 2023/4/19 at 22:36:41
...
export const promptTreeNftABI = [
  ...
  },
  {
    stateMutability: 'view',
    type: 'function',
    inputs: [{ name: 'tokneId', internalType: 'uint256', type: 'uint256' }],
    name: 'getEncryptedPrompt',
    outputs: [{ name: '', internalType: 'string', type: 'string' }],
  },
  {
    stateMutability: 'view',
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: 'encryptedPrompts', internalType: 'string', type: 'string' },
      { name: 'sourceNftTokenId', internalType: 'uint256', type: 'uint256' },
    ],
    name: 'mintNft',
    outputs: [],
  },
...
export const promptTreeNftAddress = {
  31337: '0xdD8BeAe31dEd0a3016c542cD590Bd121bD5d9A55',
} as const

/**
 *
 */
export const promptTreeNftConfig = { address: promptTreeNftAddress, abi: promptTreeNftABI } as const
